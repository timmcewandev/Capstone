//
// UntitledView.swift
// Generated by Core Animator version 1.4 on 7/17/17.
//
...
class UntitledView : UIView, CAAnimationDelegate {
    ...
    func addUntitledAnimation(beginTime: CFTimeInterval, fillMode: String, removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
        ...
        teamKaliberMaskScaleYAnimation.timingFunctions = [easeInOutTiming]
        ...
        teamKaliberMaskTranslationYAnimation.timingFunctions = [anticipateTiming]
